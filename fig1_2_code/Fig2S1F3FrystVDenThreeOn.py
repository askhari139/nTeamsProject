...
for i in np.linspace(0,1,20):
    ...
    for j in range(0,100):
        ...
        for k in triple_pos_gen(3,[0,5,10,15],15):
            print(k)
...
'''import csv
with open('data/Figure2/Fig2S1F3/NetworkFrustDist.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerows(NetworksFrustDist)

with open('data/Figure2/Fig2S1F3/FigData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
plt.title("Frustration of States with All Teams On")
plt.show()
