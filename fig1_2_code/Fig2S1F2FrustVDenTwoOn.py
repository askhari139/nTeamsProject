...
for i in np.linspace(0,1,20):
    ...
    for j in range(0,100):
        ...
        for k in random_hybrid_state(3,[0,5,10,15],15):
            print(k)
...
'''import csv
with open('data/Figure2/Fig2S1F2/NetworkFrustDist.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerows(NetworksFrustDist)

with open('data/Figure2/Fig2S1F2/FigData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
plt.title("Frustration of Random Hybrids")
plt.show()
