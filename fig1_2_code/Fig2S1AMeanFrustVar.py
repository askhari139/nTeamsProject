...
for d in [0.3,0.5,0.7,0.9]:
    ...
    '''import csv
    with open('data/Figure2/Fig2S1A/NetworksDensity{}.csv'.format(d), 'w', newline='') as csvfile:
        writer = csv.writer(csvfile)
        writer.writerows(networks)

    with open('data/Figure2/Fig2S1A/FrustDistDensity{}.csv'.format(d), 'w', newline='') as csvfile:
        writer = csv.writer(csvfile)
    ...
    plt.title("Frustration Distributions (Density={})".format(d))
    plt.show()
