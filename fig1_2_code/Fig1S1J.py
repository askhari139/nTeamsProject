...
'''import csv
with open('data/Figure1/Fig1S1J/Team5/NetworkThirdTeam.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerows(networks)

with open('data/Figure1/Fig1S1J/Team5/OneTeamOnDist.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerows(OneOnFrac)

with open('data/Figure1/Fig1S1J/Team5/FinalFig.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
