...
'''with open('data/Figure2/Fig2B/TwoTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
...
'''with open('data/Figure2/Fig2B/ThreeTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2B/FourTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2B/FiveTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2B/SixTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2B/SevenTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
plt.ylabel("Variance")
plt.legend()
plt.title("Mean vs Variance of Frustration ")
plt.show()
