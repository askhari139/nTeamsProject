...
networks=[["Team1","Team2","Team3","Adj"]]
scale=15
#density_varying_0_1
den=0.3
total_ndoes=15
...
with open('data/Figure2/Fig2E/FigData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerows(FigData)
with open('data/Figure2/Fig2E/Networks.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
