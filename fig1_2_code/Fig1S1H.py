...
'''import csv
with open('data/Figure1/Fig1S1H/Team1/NetworkThirdTeam.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerows(networks)

with open('data/Figure1/Fig1S1H/Team1/OneTeamOnDist.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerows(OneOnFrac)

with open('data/Figure1/Fig1S1H/Team1/FinalFig1k.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
