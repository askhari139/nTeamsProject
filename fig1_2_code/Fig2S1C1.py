...
'''with open('data/Figure2/Fig2S1C/den3/TwoTeamFrustFreqData.csv', 'w', newline='') as csvfile:
...
'''with open('data/Figure2/Fig2S1C/den3/ThreeTeamFrustFreqData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1C/den3/FourTeamFrustFreqData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1C/den3/FiveTeamFrustFreqData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1C/den3/SixTeamFrustFreqData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1C/den3/SevenTeamFrustFreqData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
