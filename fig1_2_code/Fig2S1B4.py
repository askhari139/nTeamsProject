...
'''with open('data/Figure2/Fig2S1B/den9/TwoTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
...
'''with open('data/Figure2/Fig2S1B/den9/ThreeTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1B/den9/FourTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1B/den9/FiveTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1B/den9/SixTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1B/den9/SevenTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
