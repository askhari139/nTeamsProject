...
'''with open('data/Figure2/Fig2S1C/den9/TwoTeamFrustFreqData.csv', 'w', newline='') as csvfile:
...
'''with open('data/Figure2/Fig2S1C/den9/ThreeTeamFrustFreqData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1C/den9/FourTeamFrustFreqData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1C/den9/FiveTeamFrustFreqData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1C/den9/SixTeamFrustFreqData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1C/den9/SevenTeamFrustFreqData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
