...
'''with open('data/Figure2/Fig2S1B/den5/TwoTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
...
'''with open('data/Figure2/Fig2S1B/den5/ThreeTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1B/den5/FourTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1B/den5/FiveTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1B/den5/SixTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1B/den5/SevenTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
