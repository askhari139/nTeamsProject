...
'''import csv
with open('data/Figure1/Fig1S1I/Team3/NetworkThirdTeam.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerows(networks)

with open('data/Figure1/Fig1S1I/Team3/OneTeamOnDist.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerows(OneOnFrac)

with open('data/Figure1/Fig1S1I/Team3/FinalFig.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
