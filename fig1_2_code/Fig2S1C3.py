...
'''with open('data/Figure2/Fig2S1C/den7/TwoTeamFrustFreqData.csv', 'w', newline='') as csvfile:
...
'''with open('data/Figure2/Fig2S1C/den7/ThreeTeamFrustFreqData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1C/den7/FourTeamFrustFreqData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1C/den7/FiveTeamFrustFreqData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1C/den7/SixTeamFrustFreqData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1C/den7/SevenTeamFrustFreqData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
