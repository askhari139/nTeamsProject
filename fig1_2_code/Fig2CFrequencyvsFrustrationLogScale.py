...
'''with open('data/Figure2/Fig2C/TwoTeamFrustFreqData.csv', 'w', newline='') as csvfile:
...
'''with open('data/Figure2/Fig2C/ThreeTeamFrustFreqData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2C/FourTeamFrustFreqData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2C/FiveTeamFrustFreqData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2C/SixTeamFrustFreqData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2C/SevenTeamFrustFreqData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
data=[[freq2,frust2],[freq3,frust3],[freq4,frust4],[freq5,frust5],[freq6,frust6]]
