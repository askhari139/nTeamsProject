...
'''with open('data/Figure2/Fig2S1B/den3/TwoTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
...
'''with open('data/Figure2/Fig2S1B/den3/ThreeTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1B/den3/FourTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1B/den3/FiveTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1B/den3/SixTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
...
'''with open('data/Figure2/Fig2S1B/den3/SevenTeamFrustMeanVarData.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
